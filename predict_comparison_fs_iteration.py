...
def predict(args):
    ...
    if 'src_smi' in test_csv.columns:
...
if __name__ == "__main__":
    for cutoff_sim in [0.4, 0.5, 0.6]:
        ...
        "result_file": f"./result/5_{cutoff_sim}_fs_comparison_result.csv",
        "log_file": "5_fs_comparison_result.log",
        "load_from": "./checkpoints/fs_comparison_mol_opt_data/model.500000_99.pt",
        "seed": 1216,
        "batch_type": "tokens",
