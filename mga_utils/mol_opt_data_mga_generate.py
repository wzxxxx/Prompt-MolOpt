...
if __name__ == '__main__':
    ...
    data_file = '../data/origin_data/Prompt_MolOpt_train_val_ADMET.csv' #data file with training and val moleculars
    ...
    train_s2s_file = '../preprocessed/s2s_mga_data/train_0.npz'
    val_s2s_file = '../preprocessed/s2s_mga_data/val_0.npz'
    test_s2s_file = '../preprocessed/s2s_mga_data/test_0.npz'
    max_len=150
    batch_size=128
    ...
    build_s2s_data(data_file=data_file, model_name=model_name, tag_list=tag_list, vocab=vocab, group='train', max_len=max_len, s2s_file=train_s2s_file, batch_size=batch_size)
    build_s2s_data(data_file=data_file, model_name=model_name, tag_list=tag_list, vocab=vocab, group='valid', max_len=max_len, s2s_file=val_s2s_file, batch_size=batch_size)

    remove_mismatch(test_data_file, vocab)
    print('Remove mismatch is over.!')
    build_s2s_data(data_file=test_data_file, model_name=model_name, tag_list=tag_list, vocab=vocab, group='test', max_len=max_len, s2s_file=test_s2s_file, batch_size=batch_size)
