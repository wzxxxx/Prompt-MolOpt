...
if __name__ == '__main__':
    ...
    # parameter
    model_name = 'QED_DRD2_data_for_MGA_few_shot'
    data_file = '../data/origin_data/Prompt_MolOpt_for_QED_DRD2_few_shot'
    vocab_file = '../preprocessed/fs_comparison_mol_opt_data/fs_comparison_vocab_smiles.txt'
    train_s2s_file = '../preprocessed/fs_comparison_mol_opt_data/train_0.npz'
    val_s2s_file = '../preprocessed/fs_comparison_mol_opt_data/val_0.npz'
    test_s2s_file = '../preprocessed/fs_comparison_mol_opt_data/test_0.npz'
    max_len=150
    batch_size=128
    task_name = 'QED_DRD2_data_for_MGA_few_shot'
