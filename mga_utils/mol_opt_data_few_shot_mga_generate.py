...
def build_s2s_data(data_file, model_name, tag_list, vocab, group='train', max_len=150, s2s_file='a.csv', batch_size=128):
    ...
    token_mga_feats = []
    # 计算各性质src_embed
    src_embed = SME_pred_for_mols(src_smis, model_name=model_name, batch_size=batch_size)
    atom_idx_start = 0
...
if __name__ == '__main__':
    ...
    data_file = '../data/origin_data/Prompt_MolOpt_train_val_ADMET_few_shot'
    vocab_file = '../preprocessed/fs_mga_data/vocab_smiles.txt'
    train_s2s_file = '../preprocessed/fs_mga_data/train_0.npz'
    val_s2s_file = '../preprocessed/fs_mga_data/val_0.npz'
    test_s2s_file = '../preprocessed/fs_mga_data/test_0.npz'
    max_len = 150
    batch_size = 128
