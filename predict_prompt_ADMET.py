...
if __name__ == "__main__":
    ...
    "test_bin": "./preprocessed/s2s_mga_data/test_0.npz",
    "test_csv": "./data/origin_data/mol_opt_data.csv",
    "result_file": "./result/Prompt_MolOpt_ADMET_result.csv",
    "log_file": "Prompt_MolOpt_ADMET_result.log",
    "load_from": "./checkpoints/s2s_mga_data/model.500000_99.pt",
