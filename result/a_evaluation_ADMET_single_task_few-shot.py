...
for add_tag_task in ['ESOL', 'lipop']:
    ...
    for i in range(1, 6):
        ...
        data = data[data['group'] == test_set]
        data_d = data_d[data_d['group'] == test_set]
    ...
    print(f'Zero-shot, {task_name} {origin_task} {add_tag_task} {round(data_t_succeed/data_t_all_num, 3)}')
