...
class TransformerEncoder(EncoderBase):
    ...
    def forward(self, src, src_mga_feats, lengths=None):
        """See :func:`EncoderBase.forward()`"""
        self._check_args(src, lengths)

        # emb = self.embeddings(src) + src_mga_feats
        emb = self.embeddings(src)

        out = emb.transpose(0, 1).contiguous()
        out = out + src_mga_feats
...
class Seq2Seq_sme(nn.Module):
    ...
    def predict_step(self, mol_opt_batch: S2SBatch,
        ...
        padded_memory_bank, memory_lengths = self.encode_and_reshape(mol_opt_batch)
        print('padded_memory_bank, memory_lengths', padded_memory_bank, memory_lengths)
        ...
        print('2', fn_map_state, memory_bank, memory_lengths, src_map)
