...
def add_common_args(parser):
    ...
    group.add_argument("--model", help="Model architecture",
                       choices=["s2s", "s2s_sme"], type=str, default="")
    group.add_argument("--data_name", help="Data name", type=str, default="")
    group.add_argument("--task", help="Task", type=str, default="")
    group.add_argument("--seed", help="Random seed", type=int, default=42)
    group.add_argument("--max_src_len", help="Max source length", type=int, default=150)
    group.add_argument("--max_tgt_len", help="Max target length", type=int, default=150)
...
def add_train_args(parser):
    ...
    group.add_argument("--beta1", help="Adam beta FW_No_Prompt_MIX_s2s_smiles_smiles", type=float, default=0.9)
...
def add_predict_args(parser):
    ...
    group.add_argument("--checkpoint_step_start", help="First checkpoints step", type=int)
    group.add_argument("--checkpoint_step_end", help="Last checkpoints step", type=int)
    group.add_argument("--predict_batch_size", help="Batch size for prediction", type=int, default=4096)
    group.add_argument("--cutoff_sim", help="similarity score cutoff", type=float, default=0.2)

    # decoding params
    group.add_argument("--test_bin", help="Test npz", type=str, default="")
    group.add_argument("--test_csv", help="Test csv", type=str, default="")
